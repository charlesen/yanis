...
class Yanis_Controller {
	 ...
	 * @param String $action
	 */
	//function __construct($controller = null, $action = null, $model = 'helper') {
	function __construct($controller = null, $action = null) {
		...
		$this->_action = isset ( $action ) ? $action : (isset ( $_SESSION ['APP_ACTION'] ) ? $_SESSION ['APP_ACTION'] : "");
		$this->_module = isset ( $_SESSION ['APP_MODULE'] ) ? $_SESSION ['APP_MODULE'] : "";
		
		//$this->_model = new $model ();
		$this->_translate = new Yanis_Translate ();
		$this->_template = new Template ();
		$this->_template->setModule ( $this->_module )->setController ( $this->_controller )->setAction ( $this->_action );
